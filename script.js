...
$(document).ready(function(){
	$(".window").each(function() {      		// window template
      ...
      if ($(this).hasClass("activeWindow")) {	$("#minimPanel" + i).addClass('activeTab');	}
    if ($(this).hasClass("minimizedWindow")) {	$("#minimPanel" + i).removeClass('activeTab').addClass('minimizedTab');	}		
